...
<head><script src="assets/js/color-modes.js"></script>
    ...
    <meta name="author" content="Jyanie">
    <title>TacticHub - 회원가입 성공</title>
...
<main class="form-signin w-100 m-auto" style="height: auto;">
    <form class="text-center" style="max-width: 500px; width: 100%;">
        ...
        <div class="container py-4 px-3 rounded" style="max-width: 480px; background-color: transparent">
            ...
            <img src="images/check_circle.png" class="mb-2" alt="success" width="200px">

            <p class="lg-title fw-bold mb-1" style="font-size: 18px;">회원가입 성공!</p>
            <!-- 제목 -->
            <div class="text-center mb-2">
                <span class="fw-medium" style="font-size: 14px">환영합니다. 정상적으로 회원가입이 완료되었습니다.</span>
            </div>


            <a href="index.jsp" class="btn btn-dark w-100 py-2 fw-bold mt-3 text-decoration-none">
                홈으로
            </a>
